...
# Title: FSK_3MV
# Author: Qi Xiong
# Description: FSK_OAC Majority voting with 3 EDs
...
class FSK_3MV(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FSK_3MV", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FSK_3MV")
        ...
        self.settings = Qt.QSettings("GNU Radio", "FSK_3MV")
        ...
        self.sps = sps = 11
        self.repeat = repeat = (int)(samp_rate*0.002)
        self.noise = noise = 0
        ...
        self.iio_pluto_sink_0_0_0 = iio.fmcomms2_sink_fc32('ip:192.168.5.1' if 'ip:192.168.5.1' else iio.get_pluto_uri(), [True, True], 4096, False)
        self.iio_pluto_sink_0_0_0.set_len_tag_key('')
        self.iio_pluto_sink_0_0_0.set_bandwidth(20000000)
        self.iio_pluto_sink_0_0_0.set_frequency(2400000000)
        self.iio_pluto_sink_0_0_0.set_samplerate(samp_rate)
        self.iio_pluto_sink_0_0_0.set_attenuation(0, 10.0)
        ...
        self.blocks_vector_source_x_0_0_2_0 = blocks.vector_source_f((0, 1, 0, 1, 0, 0, 1, 0), True, 1, [])
        self.blocks_vector_source_x_0_0_2 = blocks.vector_source_b((0, 1, 0, 1, 0, 0, 1, 0), True, 1, [])
        ...
        self.blocks_vco_f_0_0_0 = blocks.vco_f(samp_rate, (15708*10), 0.5)
        ...
        self.blocks_repeat_0_0_0 = blocks.repeat(gr.sizeof_char*1, repeat)
        ...
        self.blocks_multiply_const_vxx_0_0_0 = blocks.multiply_const_ff(inp_amp)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_int*1, 'E:\\KTH\\MaterThesis\\Trial0_3ED_ESRX.txt', False)
        self.blocks_file_sink_0.set_unbuffered(True)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, 4)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.blocks_add_const_vxx_1_0 = blocks.add_const_ff((-1.5))
        self.blocks_add_const_vxx_1 = blocks.add_const_ff((-0.28))
        self.blocks_add_const_vxx_0_0_0 = blocks.add_const_ff(vco_offset)
        ...
        self.connect((self.analog_const_source_x_0_0_0, 0), (self.blocks_float_to_complex_1_0_0, 1))
        ...
        self.connect((self.blocks_add_const_vxx_0_0_0, 0), (self.blocks_vco_f_0_0_0, 0))
        self.connect((self.blocks_add_const_vxx_1, 0), (self.digital_binary_slicer_fb_0_0, 0))
        self.connect((self.blocks_add_const_vxx_1_0, 0), (self.digital_binary_slicer_fb_0_0_0, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_add_const_vxx_1_0, 0))
        ...
        self.connect((self.blocks_float_to_complex_1_0_0, 0), (self.iio_pluto_sink_0_0_0, 0))
        ...
        self.connect((self.blocks_repeat_0_0_0, 0), (self.blocks_uchar_to_float_0_1_0, 0))
        ...
        self.connect((self.blocks_uchar_to_float_0_1_0, 0), (self.blocks_multiply_const_vxx_0_0_0, 0))
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0_0_0, 0), (self.blocks_repeat_0_0_0, 0))
        ...
        self.connect((self.blocks_vco_f_0_0_0, 0), (self.blocks_float_to_complex_1_0_0, 0))
        ...
        self.connect((self.blocks_vector_source_x_0_0_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.blocks_vector_source_x_0_0_0, 0), (self.qtgui_time_sink_x_0_0, 1))
        self.connect((self.blocks_vector_source_x_0_0_2, 0), (self.blocks_unpack_k_bits_bb_0_0_0, 0))
        self.connect((self.blocks_vector_source_x_0_0_2_0, 0), (self.blocks_add_xx_0, 2))
        self.connect((self.blocks_vector_source_x_0_0_2_0, 0), (self.qtgui_time_sink_x_0_0, 2))
        self.connect((self.blocks_vector_source_x_0_1, 0), (self.blocks_add_xx_0, 0))
        ...
        self.connect((self.digital_binary_slicer_fb_0_0_0, 0), (self.blocks_uchar_to_float_0_0_0_0, 0))
    ...
    def set_vco_offset(self, vco_offset):
        ...
        self.blocks_add_const_vxx_0_0_0.set_k(self.vco_offset)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_repeat((int)(self.samp_rate*0.002))
        self.analog_quadrature_demod_cf_1.set_gain((self.samp_rate/(2*math.pi*self.fsk_deviation)))
    ...
    def set_repeat(self, repeat):
        ...
        self.blocks_repeat_0_0_0.set_interpolation(self.repeat)
    ...
    def set_inp_amp(self, inp_amp):
        ...
        self.blocks_multiply_const_vxx_0_0_0.set_k(self.inp_amp)
...
def main(top_block_cls=FSK_3MV, options=None):
